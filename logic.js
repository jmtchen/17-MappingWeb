...
function createMap(earthquakes) {
  ...
  var map = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/outdoors-v10/tiles/256/{z}/{x}/{y}?" +
    "access_token=pk.eyJ1Ijoiam10Y2hlbiIsImEiOiJjamZzcHViMDkwaGlmMzNxbHVycWp0YThwIn0.GBMIzAyR2tOr3MT27cHA0w");

  // var darkmap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/dark-v9/tiles/256/{z}/{x}/{y}?" +
  //   "access_token=pk.pk.eyJ1Ijoiam10Y2hlbiIsImEiOiJjamZzcHViMDkwaGlmMzNxbHVycWp0YThwIn0.GBMIzAyR2tOr3MT27cHA0w");
